...
def compose(loc, excluded):
    ...
    system = (
        ...
        "Voice it Arnold Schwarzenegger trying to give a motivational speach about how kyle would never survive the heat in this given region. Make it really sound like him "
